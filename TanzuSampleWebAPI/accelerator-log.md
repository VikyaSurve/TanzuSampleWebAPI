...
{
  "gitBranch" : "main",
  "gitRepository" : "https://github.com/VikyaSurve/TanzuSampleWebAPI",
  "liveUpdateIDESupport" : false,
  "projectName" : "tanzusamplewebapi",
  "targetProject" : "tanzusamplewebapi"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [my-project->tanzusamplewebapi]
